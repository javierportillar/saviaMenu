        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              />
              <span className="text-xl font-bold">Savia</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Productos naturales y sostenibles que cuidan de ti y del planeta. 
              Comprometidos con la calidad y el bienestar desde 2020.
            </p>
